      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-wrap justify-between items-center gap-y-8 gap-x-4">
          ...
          <div className="flex items-center gap-4 min-w-[200px]">
            <Truck size={20} className="text-[#9B5656]" />
            <div>
          ...
          <div className="flex items-center gap-4 min-w-[200px]">
            <CreditCard size={20} className="text-[#9B5656]" />
            <div>
          ...
          <div className="flex items-center gap-4 min-w-[200px]">
            <RotateCcw size={20} className="text-[#9B5656]" />
            <div>
          ...
          <div className="flex items-center gap-4 min-w-[200px]">
            <ShieldCheck size={20} className="text-[#9B5656]" />
            <div>
