    ...
    <div className="min-h-screen bg-[#F7F5FF] flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full border border-[#E5E0F5] shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <Link href="/forgot-password" className="text-[#6C3FC5] text-xs hover:underline font-bold">
                Forgot password?
              </Link>
            </div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#6C3FC5] text-white py-3.5 rounded-xl font-bold font-heading text-base hover:bg-[#5530A8] transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2 shadow-lg shadow-[#6C3FC5]/20"
          >
            {loading ? (
              <>
        ...
        <p className="text-center text-sm text-[#6B7280] mt-10 font-medium">
          ...
          <Link href="/signup" className="text-[#6C3FC5] hover:underline font-bold">
            Sign up →
          </Link>
        </p>
      </div>
