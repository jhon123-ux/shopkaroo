...
export default async function SubcategoriesPage({ params }: Props) {
  ...
  if (!parentCategory) {
    return (
      <main className="max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        <Link 
          href="/categories"
          className="inline-flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full text-[11px] font-bold uppercase tracking-[2px] transition-all hover:bg-primary-dark active:scale-95 shadow-xl"
        >
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 md:py-20">
      ...
      {/* BREADCRUMB */}
      <nav className="flex items-center gap-2 mb-12 text-[11px] font-bold uppercase tracking-widest text-text-muted animate-fadeIn">
      ...
      {(!subcategories || subcategories.length === 0) ? (
        <div className="bg-surface border border-border p-20 text-center rounded-2xl">
           ...
           <Link 
            ...
            className="inline-flex items-center gap-3 bg-primary text-white px-10 py-4 rounded-full text-[11px] font-bold uppercase tracking-[2px] transition-all hover:bg-primary-dark shadow-lg"
           >
